...
lines((startMo:endMo+0.5),yClairOutflow1[startMo:endMo]+2*CD_U, col = "darkgreen",  lwd=1.5, type='l', lty=3)
lines((startMo:endMo+0.5),yClairOutflow1[startMo:endMo]-2*CD_U, col = "darkgreen",  lwd=1.5, type='l', lty=3)
lines((startMo:endMo+0.5),yClairOutflow2[startMo:endMo]+2*CD_U, col = "purple",  lwd=1.5, type='l', lty=3)   
lines((startMo:endMo+0.5),yClairOutflow2[startMo:endMo]-2*CD_U, col = "purple",  lwd=1.5, type='l', lty=3)   
...
lines((startMo:endMo+0.5),yErieOutflow1[startMo:endMo]+2*MNL_U, col = "darkgreen",  lwd=1.5, type='l', lty=3)
lines((startMo:endMo+0.5),yErieOutflow1[startMo:endMo]-2*MNL_U, col = "darkgreen",  lwd=1.5, type='l', lty=3)
...
lines((startMo:endMo+0.5),yOntarioOutflow1[startMo:endMo]+2*MNL_U, col = "darkgreen",  lwd=1.5, type='l', lty=3)
lines((startMo:endMo+0.5),yOntarioOutflow1[startMo:endMo]-2*MNL_U, col = "darkgreen",  lwd=1.5, type='l', lty=3)
